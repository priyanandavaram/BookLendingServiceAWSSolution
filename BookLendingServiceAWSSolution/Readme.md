...
Execute unit tests
```
    cd "BookLendingServiceAWSSolution/test/BookLendingServiceAWSSolution.Tests"
    dotnet test
```

Deploy application
```
    cd "BookLendingServiceAWSSolution/src/BookLendingServiceAWSSolution"
